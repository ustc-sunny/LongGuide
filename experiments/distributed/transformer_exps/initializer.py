...
def add_federated_args(parser):
    ...
    """
    ## zoo
    parser.add_argument('--v_num', type=int, default=1,
                        help='number of perturbation vectors')
    parser.add_argument('--alpha', type=float, default=0.5,
                        help='weighting parameter between perturbation and random vector')
    ...
    parser.add_argument('--manual_seed', type=int, default=57, metavar='N',
                        help='random seed')
